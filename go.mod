...
// Minimum Go language version. Pinned to the same patch as the toolchain
// directive below — anything older has known stdlib vulns (GO-2026-4918,
// -4971, -4980, -4982) and can't build this plugin safely.
go 1.26.3
